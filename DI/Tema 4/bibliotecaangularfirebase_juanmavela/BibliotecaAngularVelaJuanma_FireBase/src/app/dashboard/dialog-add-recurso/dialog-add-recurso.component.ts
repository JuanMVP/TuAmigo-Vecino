...
export class DialogAddRecursoComponent implements OnInit {
  ...
  constructor( private db: AngularFirestore,  public dialogRef: MatDialogRef<DialogAddRecursoComponent>, public snackBar: MatSnackBar ) { 
  ...
  addNewRecurso(){
    this.db.collection('recursos').add({
      ...
      .then(function (docRef) {
        console.log('Editando el documento con ID: ', docRef.id);
