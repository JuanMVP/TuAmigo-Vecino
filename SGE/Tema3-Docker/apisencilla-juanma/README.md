...
sudo docker build -t jmvela/node-web-app .

# comando para construir y ejecutar un contenedor a partir de una imagen

sudo docker run -p 49160:8080 -d jmvela/node-web-app
