...
public class SecurityConfig extends WebSecurityConfigurerAdapter {    
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(
				...
				.antMatchers("/resources/**").permitAll().and().formLogin().loginPage("/login") // Ruta del controlador
																								// del formulario de
																								// login
				.defaultSuccessUrl("/CalendarioEventos") // Ruta de redirección en caso de éxito.
