...
const { nombreCategoria, campania } = schema.tree

/**
 * @api {post} /categorias Create categoria
 * @apiName CreateCategoria
 * @apiGroup Categoria
 * @apiParam nombreCategoria Categoria's nombreCategoria.
 * @apiParam campania Categoria's campania.
 * @apiSuccess {Object} categoria Categoria's data.
 * @apiError {Object} 400 Some parameters may contain invalid values.
 * @apiError 404 Categoria not found.
 */
router.post('/',
  body({ nombreCategoria, campania }),
  create)
