...
import com.example.juanmavela.retrofit_juanma.retrofit.retrofit.generator.ServiceGenerator;
import com.example.juanmavela.retrofit_juanma.retrofit.retrofit.services.GitHubService;
...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,Arrays.asList("Item 1","Item 2", "Item 3") );
